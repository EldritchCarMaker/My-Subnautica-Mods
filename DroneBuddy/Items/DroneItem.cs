...
internal static class DroneItem
{
    ...
    internal static void RegisterDrone()
    {
        ...
        customPrefab.SetRecipe(new Nautilus.Crafting.RecipeData(new[] { new Ingredient(TechType.MapRoomCamera, 1), new(TechType.AdvancedWiringKit, 3), new(TechType.AluminumOxide, 2) }))
