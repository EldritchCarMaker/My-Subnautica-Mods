...
namespace ShieldSuit
{
    internal class ShieldSuitItem
    {
        ...
        {
            var customPrefab = new CustomPrefab("ShieldSuitItem", "Shield Suit", "suit that allows use of a short lasting, but quick charging, personal shield", GetItemSprite());
            ...
            customPrefab.SetUnlock(TechType.CyclopsShieldModule).WithPdaGroupCategory(TechGroup.Personal, TechCategory.Equipment);
